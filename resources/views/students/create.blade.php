...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h3 class="text-2xl font-black text-slate-900 tracking-tight">Tambah Siswa Baru</h3>
            <p class="text-sm text-slate-500 mt-1">Lengkapi formulir di bawah ini untuk mendaftarkan siswa baru.</p>
        </div>
    ...
    <div class="bg-white p-6 sm:p-10 rounded-3xl shadow-sm border border-slate-200/80">
        <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8" id="student-form">
            @csrf
            ...
            <div class="pt-2 border-t border-slate-100">
                <label for="photo" class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-3">
                    Unggah Foto Siswa <span class="text-xs font-normal text-slate-400 normal-case">(Opsional / Format JPG &amp; PNG)</span>
                </label>
